...
from keras.layers import LSTM, Dense, Input, Concatenate, Dropout, Bidirectional, Activation, Permute, Multiply, Lambda, LayerNormalization, Flatten, RepeatVector
...
# --- 5. MODEL DEFINITION (ATTENTION + LAYERNORM + TUNED DROPOUT) ---
# LSTM branch with LayerNormalization and Dropout(0.1)
...
print("\n--- Evaluation on Hybrid Test 3 (Attention+LayerNorm) ---")
...
# --- 10. SAVE MODEL ---
model.save('hybrid_test3_model.h5') 